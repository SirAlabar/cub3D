...
void							draw_vertical_line(t_game *g, t_line line,
									int color);
void							set_wall_tex_coords(t_wall *wall);
void							draw_wall_scanline(t_game *game, t_ray *ray,
									int x, t_scanline *buffer);
...
t_vector						get_scale_factors(t_texture *gun,
									t_vector_i dim);
void							draw_weapon_pixel(t_game *game, t_vector_i pos,
									t_vector_i gun_pos, t_texture *gun);
...
void							door_sliding(t_ray *ray, t_game *game,
									t_door *door);
 ...
 */
// texture_manager.c
t_texture						*texture_create(t_game *game,
									char *texture_path);
...
t_vector						vector_lerp(t_vector start, t_vector end,
									double amt);
...
double							get_wall_x(t_ray *ray, t_game *game,
									double orig_dist);
void							set_door_hit(t_ray *ray, double orig_dist);
bool							is_within_map_bounds(t_game *game, int x,
									int y);
